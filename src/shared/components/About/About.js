  ...
  return (
    <Box padding={2}>
      ...
      <Typography paragraph>
        The app allow people to share Spotify control. Add tracks to the queue,
        skip etc.
      </Typography>
      ...
      <Typography paragraph>
        No! This is the main benefit over using Spotify Group Sessions. There is
        no need to set it up on every use.
      </Typography>
      ...
      <Typography paragraph>
        Yes. You can, whenever you want, revoke a consent. Note that keys handed
        out might be valid for up to 1 hour. You can revoke the main key on{" "}
        <Link
          target="_blank"
          rel="noreferrer"
